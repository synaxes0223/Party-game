...
test("teamOf and charactersOfTeam reflect the sixteen-character registry", () => {
  ...
  assert.deepEqual(characters.charactersOfTeam("townsfolk").sort(), ["chef", "empath", "fortuneTeller", "investigator", "librarian", "monk", "slayer", "soldier", "virgin", "washerwoman"]);
